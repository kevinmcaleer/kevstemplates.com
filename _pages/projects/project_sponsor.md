...
section: Project
process: startup
description: The Project Sponsor role - the senior champion who secures funding, owns business outcomes, and removes blockers for the project.
tags: [Roles, Sponsor, Governance, Business Case, Benefits]
...
<div class="mermaid">
flowchart LR
    A[Visible<br/>Support] --> B[Timely<br/>Decisions]
    B --> C[Removes<br/>Blockers]
    C --> D[Owns<br/>Benefits]
    D --> A
...
- [Benefits Review](/projects/benefits_review) - Tracking post-project value
