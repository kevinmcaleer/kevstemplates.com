...
name: "Behavioural Diagnosis Canvas"
permalink: /behavioural-change/behavioural-diagnosis-canvas/
section: "Diagnose"
order: 3
kind: "worksheet"
...
⚠️ If you can only describe success in terms of system usage or project milestones, go to [Target Behaviour Definition](/behavioural-change/target-behaviour-definition/).
...
Create a note per behaviour from [T — Behaviour Note](/behavioural-change/t-behaviour-note/).

## 5 · COM-B barrier scan

For your top behaviour. Score each 1 (total blocker) to 5 (no issue). See [COM-B and the Behaviour Change Wheel](/behavioural-change/com-b-and-the-behaviour-change-wheel/).
...
**The evidence column is the point**

If your evidence is "we assume" or "the steering group thinks", you have an opinion, not a diagnosis. Go and have six conversations — [Barrier Analysis — COM-B Interview Guide](/behavioural-change/barrier-analysis-com-b-interview-guide/).
</div>
...
Bright spots are the cheapest source of solutions and the most credible evidence you'll ever put in front of a sceptic. See [Switch — Rider Elephant Path](/behavioural-change/switch-rider-elephant-path/).
...
|---|---|---|---|
| Sponsor goes quiet | | | [Sponsor Briefing Pack](/behavioural-change/sponsor-briefing-pack/) |
| Change saturation | | | [Change Readiness Assessment](/behavioural-change/change-readiness-assessment/) |
| Middle managers don't cascade | | | [Manager Conversation Guide](/behavioural-change/manager-conversation-guide/) |
| Design is genuinely worse for users | | | [Resistance Decoder](/behavioural-change/resistance-decoder/) |
| | | | |
{:class="table table-single table-narrow"}
...
→ Next: [Target Behaviour Definition](/behavioural-change/target-behaviour-definition/) · [Stakeholder Map and Power Grid](/behavioural-change/stakeholder-map-and-power-grid/) · [Change on a Page](/behavioural-change/change-on-a-page/)
