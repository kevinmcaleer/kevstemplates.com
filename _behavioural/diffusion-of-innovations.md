...
permalink: /behavioural-change/diffusion-of-innovations/
section: "Frameworks"
order: 2
kind: "framework"
...
⚠️ One exception: if the sceptic is technically right about a design flaw, that's not resistance, that's free consultancy. See [Resistance Decoder](/behavioural-change/resistance-decoder/).
