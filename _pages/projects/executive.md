...
section: Project
process: startup
description: The Executive role - chairs the Project Board, owns the business case, and is ultimately accountable for project success.
tags: [Roles, Executive, Project Board, Business Case, Governance]
...
<div class="mermaid">
flowchart LR
    E[Executive] --> B[Business<br/>Value]
    E --> U[User<br/>Needs]
    E --> S[Supplier<br/>Capability]
    B --> D[Balanced<br/>Decisions]
    U --> D
    S --> D

    classDef blue fill:#108BB9,stroke:none,color:#fff
    class E,B,U,S,D blue
</div>
...
- [Project Change Control](/projects/project_change_control) - Executive authority over changes
