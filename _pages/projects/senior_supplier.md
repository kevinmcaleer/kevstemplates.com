...
section: Project
process: startup
description: The Senior Supplier role - represents those delivering the product on the Project Board, ensuring the solution is feasible, sound, and properly resourced.
tags: [Roles, Senior Supplier, Project Board, Delivery, Solution]
...
<div class="mermaid">
flowchart LR
    A[Multiple<br/>Suppliers] --> B{Lead<br/>Supplier?}
    B -->|Yes| C[Lead<br/>Speaks for All]
    B -->|No| D[Multiple<br/>Senior Suppliers]
    C --> E[Cleaner<br/>Governance]
    D --> F[Direct<br/>Representation]
...
- [Build & Procure](/projects/build_procure) - Build vs buy decisions
